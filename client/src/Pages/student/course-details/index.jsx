...
// import Logo1 from "../../../../public/react4.png";
...
function StudentViewCourseDetailsPage() {
  ...
  useEffect(() => {
    if (id) {
      setCurrentCourseDetailsId(id); // Set the course ID from the URL
      fetchStudentViewCourseDetails(id); // Pass the course ID directly
    }
  }, [id]);
          ...
          handler: async function (response) {
            try {
              ...
              if (captureResponse.success) {
                navigate(`/payment-success?paymentId=${response.razorpay_payment_id}&orderId=${response.razorpay_order_id}&razorpay_signature=${response.razorpay_signature}`);              } else {
